...
<p align="center">
<img src="https://img.shields.io/github/downloads-pre/janssen-io/foundry-tokenhotbar-js/v1.1.0/token-hotbar.zip?label=v1.1.0" alt="v1.1.0 downloads" />
<img src="https://img.shields.io/endpoint?url=https://foundryshields.com/version?url=https://github.com/janssen-io/foundry-tokenhotbar-js/releases/download/v1.1.0/module.json" alt="Supported Foundry VTT version"/>
</p>
